...
console.log('%c👋 Welcome to Mason Morrow\'s Portfolio', 'font-size: 20px; font-weight: bold; color: #4A90E2;');
console.log('%cInterested in the code? Feel free to explore!', 'font-size: 14px; color: #666;');
