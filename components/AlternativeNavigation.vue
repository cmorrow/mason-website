<template>
  <nav class="sticky top-0 z-50 bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 backdrop-blur-md border-b border-blue-700/30 shadow-lg">
    <UContainer>
      <div class="flex items-center justify-between h-16">
        ...
        <div class="hidden md:flex items-center gap-3">
          ...
          >
            ...
            <span v-if="isActive(link.path)" class="absolute inset-0 rounded-full bg-gradient-to-r from-blue-200 via-white to-blue-200 opacity-20 animate-pulse"></span>
          </NuxtLink>
        </div>
